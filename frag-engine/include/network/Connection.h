 ...
 */
class FVDECLSPEC Connection : public UIDObject{
...
public:
	...
	const char *getExternalIP(void) const;
	...
	unsigned int getExternalPort(void) const;

	/**
	 *	Get the UID of this connection.
	 *
	 *	@Return unique ID.
	 */
...
protected:	/*	Internal methods. */
	...
	void* intcompress(void);
	void* intencrypt(void);
	void* intuncompress(void);
	void* intdecrypt(void);
